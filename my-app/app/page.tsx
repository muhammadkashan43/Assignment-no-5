...
export default function Home() {
  useEffect(() => {
    alert(" please adjust your screen resolution to 1366 x 768.");
  }, [])
  return (
    <>
      <section>
        <header>
          <div className="bg-[#A29875] flex w-full h-[65px] items-center xl:h-[90px]  ">
            <div className="ml-8 cursor-pointer w-[170px] ">
              <Image
                src={"/Group 14222.png"}
                alt="logo"
                width={400}
            ...
            <div className="flex items-center relative ">
              <input
                className={`${nunitoSans.className} text-black text-sm w-[700px] p-[8px] pl-6 ml-44 rounded-lg focus:outline-none pr-9`}
                type="text"
                placeholder="Search for Gold Jewellery, Diamond and more..."
              />
              <a
                href="#"
                className="absolute fill-black w-5 left-[845px] hover:scale-110 transition-transform duration-400"
              >
                <svg
                  viewBox="0 0 24 24"
      ...
      <section>
        <main>
          <div className="absolute left-20 top-36 w-[1200px] h-[450px] flex">
            <div>
              <h1
                className={`${libreBodoni.className} absolute font-bold w-[450.97px] leading-relaxed text-4xl h-[162.53px] tracking-wide top-7`}
              >
                IMPECCABLE CRAFTSMANSHIP AND FINESSE
              </h1>
              <p
                className={`${libreBodoni.className} absolute text-[#787054] top-[225px] w-[730px] text-[24px] leading-8 tracking-wide `}
              >
              ...
              <button
                className={`${libreBodoni.className} bg-[#A29875] text-white absolute px-10 py-[6px] text-[18px] rounded-lg top-[368px] hover:scale-110 transition-transform duration-400`}
              >
                Explore Now
              </button>
            </div>
            <div className="absolute left-[800px] rounded-tl-[150px] rounded-br-[150px] w-[500px] ">
                <Image
